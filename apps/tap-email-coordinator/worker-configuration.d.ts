/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 436740a93824a71f03b0ea7e8c2bb255)
// Runtime types generated with workerd@1.20260811.1 2026-07-21 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	TAP_INTROSPECTION_URL: string;
	ALLOWED_ORIGINS: string;
	GOOGLE_REDIRECT_URI: string;
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	GOOGLE_TOKEN_ENCRYPTION_KEY: string;
	ATTACHMENT_STAGING_ENCRYPTION_KEY: string;
	WEBSITE_REFERRALS: Service /* entrypoint WebsiteReferralsPublisher from tap-website-referrals-production */ | Service /* entrypoint WebsiteReferralsPublisher from tap-website-referrals-dev */;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		GOOGLE_TOKEN_ENCRYPTION_KEY: string;
		ATTACHMENT_STAGING_ENCRYPTION_KEY: string;
		WEBSITE_REFERRALS: Service /* entrypoint WebsiteReferralsPublisher from tap-website-referrals-production */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOW_DEV_IDENTITY" | "TAP_INTROSPECTION_URL" | "ALLOWED_ORIGINS" | "GOOGLE_REDIRECT_URI" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_TOKEN_ENCRYPTION_KEY" | "ATTACHMENT_STAGING_ENCRYPTION_KEY">> {}
}
