/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=wrangler.types.env --strict-vars=false` (hash: bf2d0cb7db0b4f1855eed60e90bd554e)
// Runtime types generated with workerd@1.20260811.1 2026-08-14 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	CALENDAR_DB: D1Database;
	EMAIL?: SendEmail;
	PUBLIC_AVAILABILITY_RATE_LIMITER: RateLimit;
	PUBLIC_BOOKING_RATE_LIMITER: RateLimit;
	PUBLIC_MANAGEMENT_RATE_LIMITER?: RateLimit;
	ALLOWED_ORIGINS: string;
	AUTH0_DOMAIN: string;
	AUTH0_AUDIENCE: string;
	PUBLIC_BASE_URL: string;
	PUBLIC_BOOKING_BASE_URL: string;
	PUBLIC_TURNSTILE_SITE_KEY?: string;
	PUBLIC_BOOKING_EMAIL_FROM?: string;
	PUBLIC_BOOKING_EMAIL_FROM_NAME?: string;
	AUTHZ_API: Service /* entrypoint AuthzRpc from ze-agency-authz-api-production */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "AUTH0_DOMAIN" | "AUTH0_AUDIENCE" | "PUBLIC_BASE_URL" | "PUBLIC_BOOKING_BASE_URL" | "PUBLIC_TURNSTILE_SITE_KEY" | "PUBLIC_BOOKING_EMAIL_FROM" | "PUBLIC_BOOKING_EMAIL_FROM_NAME">> {}
}
