/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: a239006e4419289337d6849a3797fc6e)
...
interface __BaseEnv_Env {
	...
	TAP_BROWSER_ASSERTION_ISSUER: string;
	TAP_BROWSER_ASSERTION_AUDIENCE: string;
	WORKFLOW_SERVICE_ACTOR_ID: string;
	WORKFLOW_SERVICE_WORKSPACE_ID: string;
	WORKFLOW_SERVICE_PACKAGE_ID: string;
	WORKFLOW_SERVICE_INSTALLATION_ID: string;
	WORKFLOW_SERVICE_CONTRIBUTION_ID: string;
	MCP_LOCAL_WORKSPACE_ID: string;
	MCP_LOCAL_PACKAGE_ID: string;
	MCP_LOCAL_CONTRIBUTION_ID: string;
	MAX_ACTIVE_SESSIONS_PER_WORKSPACE: string;
	MAX_ACTIVE_SESSIONS_PER_ACTOR: string;
	MAX_SESSION_CREATES_PER_MINUTE: string;
	MAX_SNAPSHOTS_PER_MINUTE: string;
	BROWSER_RUN_INACTIVITY_TIMEOUT_MS: string;
	MAX_SESSION_LIFETIME_MS: string;
	TAP_BROWSER_ASSERTION_PUBLIC_JWK: string;
	MCP_LOCAL_INSTALLATION_ATTESTATION_SECRET: string;
	WORKFLOW_SERVICE_TOKEN: string;
	BROWSER_SESSIONS: DurableObjectNamespace<import("./src/index").BrowserSessionCoordinator>;
	BROWSER_OWNER_QUOTAS: DurableObjectNamespace<import("./src/index").BrowserOwnerQuota>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BrowserSessionCoordinator" | "BrowserOwnerQuota";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "ALLOWED_HOSTS" | "TAP_BROWSER_ASSERTION_ISSUER" | "TAP_BROWSER_ASSERTION_AUDIENCE" | "WORKFLOW_SERVICE_ACTOR_ID" | "WORKFLOW_SERVICE_WORKSPACE_ID" | "WORKFLOW_SERVICE_PACKAGE_ID" | "WORKFLOW_SERVICE_INSTALLATION_ID" | "WORKFLOW_SERVICE_CONTRIBUTION_ID" | "MCP_LOCAL_WORKSPACE_ID" | "MCP_LOCAL_PACKAGE_ID" | "MCP_LOCAL_CONTRIBUTION_ID" | "MAX_ACTIVE_SESSIONS_PER_WORKSPACE" | "MAX_ACTIVE_SESSIONS_PER_ACTOR" | "MAX_SESSION_CREATES_PER_MINUTE" | "MAX_SNAPSHOTS_PER_MINUTE" | "BROWSER_RUN_INACTIVITY_TIMEOUT_MS" | "MAX_SESSION_LIFETIME_MS" | "TAP_BROWSER_ASSERTION_PUBLIC_JWK" | "MCP_LOCAL_INSTALLATION_ATTESTATION_SECRET" | "WORKFLOW_SERVICE_TOKEN">> {}
}
