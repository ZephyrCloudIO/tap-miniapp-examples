/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 3b2fa2d91e05fa67f8fd935318c1ac18)
...
interface __BaseEnv_Env {
	...
	COUNTDOWN_MS: string;
	MAX_PLAYERS: string;
	DISCONNECT_GRACE_SECONDS: string;
	TAP_JWT_ISSUER: string;
	TAP_JWT_AUDIENCE: string;
	ALLOWED_ORIGINS: string;
	TICKET_SECRET: string;
	RACE_ROOM: DurableObjectNamespace<import("./src/index").RaceRoom>;
	RACE_REGISTRY: DurableObjectNamespace<import("./src/index").ChannelRegistry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RaceRoom" | "ChannelRegistry";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOW_DEV_IDENTITY" | "TICKET_TTL_SECONDS" | "COUNTDOWN_MS" | "MAX_PLAYERS" | "DISCONNECT_GRACE_SECONDS" | "TAP_JWT_ISSUER" | "TAP_JWT_AUDIENCE" | "ALLOWED_ORIGINS" | "TICKET_SECRET">> {}
}
