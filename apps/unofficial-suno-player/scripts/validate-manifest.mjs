...
console.log(`manifest.tap.json, ${eventSchemas.length} event schemas, and ${workflowReferences.length} workflow schema references are valid against SDK 0.4.6 contracts`);
