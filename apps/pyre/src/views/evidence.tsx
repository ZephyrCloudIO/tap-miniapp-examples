...
interface Props { investigation: Investigation; actor: Actor; saving: boolean; context: PlatformContext; authorize: PyreAuthorityGuard; onUpdate(next: Investigation, notice: string): Promise<boolean> }
...
export function EvidenceView({ investigation, actor, saving, context, authorize, onUpdate }: Props) {
...
function EvidenceCard({ item, investigation, actor, editable, authorize, onUpdate }: { item: Evidence; investigation: Investigation; actor: Actor; editable: boolean; authorize: PyreAuthorityGuard; onUpdate(next: Investigation, notice: string): Promise<boolean> }) {
  const auditMutation = useAuditMutation();
