...
export function ReportsView({ investigation, actor, saving, authorize, onUpdate }: Props) {
  ...
  return <div className="view-stack">
    ...
    <Card className="publication-card"><CardHeader><CardTitle>Zephyr Cloud Publication</CardTitle><Badge variant="outline">Unavailable in SDK 0.4.2</Badge></CardHeader><CardContent><p>TAP SDK 0.4.2 does not expose Zephyr build or publication operations. Pyre therefore does not display a publish control or simulate a resulting URL. Approved report sources, HTML, digests, and revision history remain available for an authorized future publisher.</p></CardContent></Card>
