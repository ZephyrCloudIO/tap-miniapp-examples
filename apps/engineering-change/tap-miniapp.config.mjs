...
export default defineTapMiniapp({
  ...
  targets: {
    ...
    quickjs: {
      ...
      exposes: {
        "./mcp/engineering-change-mcp": { source: "./src/mcp.ts", runtime: "quickjs" },
      },
      builder,
    },
  },
  ...
  publisher: zephyrPublisher({
    coordinates: { organization: "zephyrcloudio", project: "tap-miniapp-examples", application: "engineering-change" },
  }),
});
