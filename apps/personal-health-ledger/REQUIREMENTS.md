...
- [ ] Host reminders and allowed reminder windows — blocked by the absence of reminder/notification scheduling APIs in SDK 0.7.0.
...
- [ ] Revocable cross-user sharing — not exposed because SDK 0.7.0 provides no package-scoped sharing grant/revocation API for this user-private ledger.
