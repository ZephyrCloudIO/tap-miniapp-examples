...
if (javascriptAssets.size === 0) {
  throw new Error("Remote Browser prototype has no federated JavaScript assets.");
}
...
if (reactRuntimeCount !== 1) {
  throw new Error(
    `Remote Browser prototype must contain exactly one React hook runtime; found ${reactRuntimeCount}.`,
  );
}
console.log(
