...
- A complete 52-method inventory of `vanta-auditor-api-sdk@0.9.10`, surfaced honestly as API-only because TAP miniapp SDK `0.0.1` has no bearer-credential or host HTTP request bridge.
