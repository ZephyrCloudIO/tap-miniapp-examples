  ...
  return (
    <div className="content-stack">
      <section className="summary-grid">
        ...
        <MetricCard icon={<ShieldCheck />} label="Public protection" value="Setup pending" detail="Turnstile verification and public rate limits are not deployed yet" tone="orange" />
      </section>
...
function AutomationsScreen({ state }: { readonly state: CalendarState }) {
  return (
    <div className="content-stack">
      ...
      <section className="slash-command panel"><span className="command-mark">/</span><div><span className="eyebrow">Channel scheduling</span><h2>/schedule</h2><p>The channel command opens a dedicated scheduler with trusted TAP members when the host exposes its participant roster. Manual external guests remain available when the roster capability is unavailable.</p></div><span className="status-chip status-confirmed">Declared</span></section>
    </div>
  );
}
            ...
            <section className="public-booking-main">
              {step === "date" ? (
                ...
                <form className="public-details public-booking-details" onSubmit={submit}>
                  ...
                  <div className="turnstile-sim"><ShieldCheck /><span><strong>Protection check passed</strong><small>Managed Turnstile · local simulation</small></span><Check /></div>
