...
```json
"@theaiplatform/miniapp-sdk": "0.9.0"
```
...
| 9 | [TAP Email](./miniapps/09-tap-email.md) | Consumer | Encrypted cloud Gmail model plus private profile SQLite cache | Live v0 implemented; deployment configuration required |
