...
```json
"@theaiplatform/miniapp-sdk": "0.4.6"
```
...
| 7 | [Kart Royale](./miniapps/07-kart-royale.md) | Consumer | TAP storage plus a Cloudflare session server for channel multiplayer | Approved concept; multiplayer implemented |
